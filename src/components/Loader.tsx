...
const Loader: React.FC<LoaderProps> = ({className}) => {
    ...
    return (
        <div className={`fill-blue-700 stroke-blue-700 min-w-4 min-h-4 ${className}`}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
                <circle strokeWidth="15" r="15" cx="35" cy="100">
